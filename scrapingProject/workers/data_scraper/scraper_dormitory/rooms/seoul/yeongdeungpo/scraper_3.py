...
'''
    ...
    method : GET
    url : https://www.ydp.go.kr/www/selectBbsNttList.do?bbsNo=40&&pageUnit=10&key=3343&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.ydp.go.kr/www/selectBbsNttView.do?bbsNo=40&nttNo={post_id}&&pageUnit=10&searchCtgry=%EA%B5%90%ED%86%B5&key=3343&pageIndex=1
    header :
        None
