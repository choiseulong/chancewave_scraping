...
'''
    ...
    method : GET
    url : https://www.ydp.go.kr/www/selectBbsNttList.do?bbsNo=40&&pageUnit=10&searchCtgry=%%EC%%9D%%BC%%EC%%9E%%90%%EB%%A6%%AC%%C2%%B7%%EA%%B8%%B0%%EC%%97%%85&key=3318&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.ydp.go.kr/www/selectBbsNttView.do?bbsNo=40&nttNo={post_id}&&pageUnit=10&searchCtgry=%EC%83%9D%ED%99%9C%EA%B2%BD%EC%A0%9C&key=3444
    header :
        None
