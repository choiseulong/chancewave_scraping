...
'''
    ...
    method : GET
    url : https://www.ydp.go.kr/health/selectBbsNttList.do?bbsNo=317&&pageUnit=10&key=3723&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.ydp.go.kr/health/selectBbsNttView.do?bbsNo=317&nttNo={post_id}&&pageUnit=10&key=3723
    header :
        None
...
def post_list_parsing_process(**params):
    ...
    table_column_list = ['번호', '제목', '부서', '작성일', '조회수', '파일']
