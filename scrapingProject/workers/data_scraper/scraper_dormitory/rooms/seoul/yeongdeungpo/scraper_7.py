...
'''
    ...
    method : GET
    url : https://www.ydp.go.kr/www/selectBbsNttList.do?bbsNo=40&&pageUnit=10&searchCtgry=%%EC%%83%%9D%%ED%%99%%9C%%EA%%B2%%BD%%EC%%A0%%9C&key=3444&pageIndex={page_count}
    header :
        None
