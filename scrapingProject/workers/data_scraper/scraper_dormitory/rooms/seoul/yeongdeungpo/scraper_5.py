...
'''
    ...
    method : GET
    url : https://www.ydp.go.kr/www/selectBbsNttList.do?bbsNo=40&&pageUnit=10&searchCtgry=%%EB%%8F%%84%%EC%%8B%%9C%%C2%%B7%%EC%%A3%%BC%%ED%%83%%9D&key=3394&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.ydp.go.kr/www/selectBbsNttView.do?bbsNo=40&nttNo={post_id}&&pageUnit=10&searchCtgry=%EB%8F%84%EC%8B%9C%C2%B7%EC%A3%BC%ED%83%9D&key=3394
    header :
        None
