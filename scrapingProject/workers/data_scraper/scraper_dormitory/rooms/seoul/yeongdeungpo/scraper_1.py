...
'''
    ...
    method : GET
    url : https://www.ydp.go.kr/www/selectBbsNttList.do?bbsNo=40&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.ydp.go.kr/www/selectBbsNttView.do?bbsNo=40&nttNo={post_id}&&pageUnit=10&key=3257
    header :
        None
...
def post_list_parsing_process(**params):
    ...
    pagination_area = soup.find('div', class_='p-pagination')
    last_page_move_link = pagination_area.find('a', class_='next-end')
    last_page_num = last_page_move_link.get('data-cpn')
