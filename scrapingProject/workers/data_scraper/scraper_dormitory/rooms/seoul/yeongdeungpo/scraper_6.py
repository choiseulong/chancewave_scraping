...
'''
    ...
    method : GET
    url : https://www.ydp.go.kr/www/selectBbsNttList.do?bbsNo=40&&pageUnit=10&searchCtgry=%%EB%%B6%%80%%EB%%8F%%99%%EC%%82%%B0&key=3419&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.ydp.go.kr/www/selectBbsNttView.do?bbsNo=40&nttNo={post_id}&&pageUnit=10&searchCtgry=%EB%B6%80%EB%8F%99%EC%82%B0&key=3419
    header :
        None
