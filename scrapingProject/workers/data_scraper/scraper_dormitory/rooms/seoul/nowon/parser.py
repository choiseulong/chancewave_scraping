...
def post_list_parsing_process(**params):
    ...
    # 2021-01-18 
    var['table_header'] = ["번호", "제목", "담당부서", "등록일", "조회", "파일"]
...
def post_content_parsing_process(**params):
    ...
    var, soup, key_list, _ = html_type_default_setting(params, target_key_info)
    var['post_title'] = extract_text_from_single_tag(soup, 'h1', child_tag_attrs={'class':'article-subject'})
    ...
    for info in tmp_info:
        ...
        if '전화번호' in info_text:
            ...
            break
    tmp_contents = extract_children_tag(soup, 'div', child_tag_attrs={'class':'article-body'})
