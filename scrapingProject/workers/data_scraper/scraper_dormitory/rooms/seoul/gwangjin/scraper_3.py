...
'''
    ...
    method : GET
    url : https://www.gwangjin.go.kr/portal/bbs/B0000279/list.do?menuNo=201448&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.gwangjin.go.kr/portal/bbs/B0000279/view.do?nttId={post_id}&menuNo=201448
    header :
        None
