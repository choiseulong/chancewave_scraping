...
'''
    ...
    method : GET
    url : https://www.gangbuk.go.kr/www/boardList.do?page={page_count}&boardSeq=49&key=297
    header :
        None
...
'''
    @post info
    method : GET
    url : 'https://www.gangbuk.go.kr/www/boardView.do?post={postId}&page=1&boardSeq=49&key=297
    header :
        None
