...
'''
    ...
    method : GET
    url : https://www.gangseo.seoul.kr/health/ht060701?curPage={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.gangseo.seoul.kr/gs020402/{post_id}?
    header :
        None
...
class Scraper(ABCScraper):
    def __init__(self, session):
        ...
        self.post_board_name = '보건소 공지/새소식'
...
def post_list_parsing_process(**params):
    ...
    table_column_list = ['순번', '제목', '작성자', '작성일', '조회수']
