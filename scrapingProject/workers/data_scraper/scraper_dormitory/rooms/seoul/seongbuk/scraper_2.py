...
'''
    ...
    method : GET
    url : https://www.sb.go.kr/cop/bbs/selectBoardList.do?bbsId=Y0001_main&bbsTyCode=BBST01&bbsAttrbCode=BBSA03&searchCnd=0&searchCnd2=&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.sb.go.kr/cop/bbs/selectBoardArticle.do?bbsId=Y0001_main&nttId={post_id}
    header :
        None
...
class Scraper(ABCScraper):
    def __init__(self, session):
        ...
        self.post_board_name = '청년정책 모집공고'
