...
'''
    ...
    method : GET
    url : https://www.sb.go.kr/bogunso/board/notice/COMANN/list.do?cateCode=COMANN&idx=&searchCnd=0&page={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.sb.go.kr/bogunso/board/notice/COMANN/view.do?cateCode=COMANN&idx={postId}
    header :
        None
        ...
        for idx, tmp_td in enumerate(tmp_post_row.find_all('td')):
            ...
            if idx == 0:
                ...
                var['post_url'].append(make_absolute_url(
                    in_url='/bogunso/board/notice/COMANN/view.do?cateCode=COMANN&idx='+tmp_idx,
