...
'''
    ...
    method : GET
    url : https://www.sb.go.kr/cop/bbs/selectBoardList.do?bbsId=B0316_main&bbsTyCode=BBST01&bbsAttrbCode=BBSA23&searchCnd=0&searchCnd2=101&pageIndex={page_count}
    header :
        None
