...
'''
    ...
    method : GET
    url : https://www.jongno.go.kr/portal/bbs/selectBoardList.do?bbsId=BBSMSTR_000000000211&menuId=1754&menuNo=1754&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.jongno.go.kr/portal/bbs/selectBoardArticle.do?bbsId=BBSMSTR_000000000911&menuNo=400222&menuId=400222&nttId={postId}
    header :
        None
...
def post_list_parsing_process(**params):
    ...
    table_column_list = ['번호', '제목', '첨부파일', '담당부서', '등록일', '조회수']
        ...
        for idx, tmp_td in enumerate(tmp_post_row.find_all('td')):
            ...
            if idx == 0:
                ...
                var['post_url'].append(make_absolute_url(
                    in_url='/portal/bbs/selectBoardArticle.do?bbsId=BBSMSTR_000000000211&menuNo=1754&menuId=1754&nttId='+tmp_post_id,
