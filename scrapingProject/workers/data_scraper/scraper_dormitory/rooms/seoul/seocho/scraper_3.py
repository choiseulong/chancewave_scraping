...
'''
    ...
    method : GET
    url : https://www.seocho.go.kr/site/seocho/ex/bbs/List.do?pageIndex={page_count}&cbIdx=59
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.seocho.go.kr/site/seocho/ex/bbs/View.do?cbIdx=59&bcIdx={post_id}
    header :
        None
