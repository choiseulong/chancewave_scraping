...
'''
    ...
    method : GET
    url : https://www.seocho.go.kr/site/sh/ex/bbs/List.do?pageIndex={page_count}&cbIdx=91
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.seocho.go.kr/site/sh/ex/bbs/View.do?cbIdx=91&bcIdx={post_id}
    header :
        None
