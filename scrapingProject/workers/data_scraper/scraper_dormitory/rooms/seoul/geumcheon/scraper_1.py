...
'''
    ...
    method : GET
    url : https://www.geumcheon.go.kr/portal/selectBbsNttList.do?key=296&bbsNo=100&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.geumcheon.go.kr/portal/selectBbsNttView.do?key=296&id=&bbsNo=100&nttNo={post_id}
    header :
        None
...
class Scraper(ABCScraper):
    def __init__(self, session):
        ...
        self.channel_name = '금천구'
        self.post_board_name = '타기관소식'
        self.channel_main_url = 'https://www.geumcheon.go.kr'
...
def post_list_parsing_process(**params):
    ...
    table_column_list = ['번호', '제목', '유관기관명', '등록일', '조회수']
...
def post_content_parsing_process(**params):
    ...
    for tmp_row_area in content_info_area.find_all('tr'):
        for tmp_info_title, tmp_info_value in zip(tmp_row_area.find_all('th'), tmp_row_area.find_all('td')):
            ...
            elif tmp_info_title_text == '유관기관명':
