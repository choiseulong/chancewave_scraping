...
'''
    ...
    method : GET
    url : https://www.mapo.go.kr/site/health/board/notice/list?cp={page_count}&bcId=notice
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.mapo.go.kr/site/health/board/notice/{post_id}
    header :
        None
...
def post_list_parsing_process(**params):
    ...
    table_column_list = ['순번', '제목', '담당부서', '첨부파일', '작성일', '수정일']
