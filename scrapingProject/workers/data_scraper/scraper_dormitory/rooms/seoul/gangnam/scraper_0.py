...
'''
    ...
    method : GET
    url : https://www.gangnam.go.kr/board/B_000001/list.do?mid=ID05_040101&pgno={page_count}&deptField=BDM_DEPT_ID
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.gangnam.go.kr/board/B_000001/{postId}/view.do?mid=ID05_040101&pgno=1&deptField=BDM_DEPT_ID
    header :
        None
