...
'''
    ...
    method : GET
    url : https://www.songpa.go.kr/ehealth/selectBbsNttList.do?bbsNo=179&&pageUnit=10&key=4713&searchAditfield4=&searchAditfield5=&viewBgnde=&searchAditfield1=&searchAditfield2=&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.gangdong.go.kr/health/site/main/board/notic/{post_id}
    header :
        None
...
def post_list_parsing_process(**params):
    ...
    table_column_list = ['번호', '제목', '담당부서', '작성일']
