...
'''
    ...
    method : GET
    url : https://www.yangcheon.go.kr/site/health/ex/bbs/List.do?cbIdx=723&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.yangcheon.go.kr/site/health/ex/bbs/View.do?cbIdx=723&bcIdx={post_id}
    header :
        None
