...
'''
    ...
    method : GET
    url : https://www.gwanak.go.kr/site/gwanak/ex/bbs/List.do?cbIdx=491&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.gwanak.go.kr/site/gwanak/ex/bbs/View.do?cbIdx=491&bcIdx={post_id}
    header :
        None
