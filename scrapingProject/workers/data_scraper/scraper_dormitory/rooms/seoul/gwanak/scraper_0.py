...
'''
    ...
    method : GET
    url : https://www.gwanak.go.kr/site/gwanak/ex/bbs/List.do?cbIdx=239&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.gwanak.go.kr/site/gwanak/ex/bbs/View.do?cbIdx=239&bcIdx={postId}
    header :
        None
...
def post_list_parsing_process(**params):
    ...
    table_column_list = ['번호', '카테고리', '제목', '담당부서', '작성일', '조회수']
        ...
        for idx, tmp_td in enumerate(tmp_post_row.find_all('td')):
            ...
            if idx == 0:
                ...
                var['post_url'].append(make_absolute_url(
                    in_url='/site/gwanak/ex/bbs/View.do?' + tmp_query,
