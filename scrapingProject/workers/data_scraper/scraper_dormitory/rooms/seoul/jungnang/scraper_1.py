...
'''
    ...
    method : GET
    url : https://www.jungnang.go.kr/portal/bbs/list/B0000242.do?menuNo=200379&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.jungnang.go.kr/portal/bbs/view/B0000242/{post_id}.do?menuNo=200379
    header :
        None
...
def post_list_parsing_process(**params):
    ...
    table_column_list = ['번호', '제목', '파일', '등록일', '조회수']
