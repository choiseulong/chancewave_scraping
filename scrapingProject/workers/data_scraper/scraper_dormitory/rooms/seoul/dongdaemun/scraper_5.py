...
'''
    ...
    method : GET
    url : https://health.ddm.go.kr/sub06/sub06_01_01_noticeBBS/list.jsp?page={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://health.ddm.go.kr/sub06/sub06_01_01_noticeBBS/view.jsp?bid=86&pid={post_id}&page=5
    header :
        None
