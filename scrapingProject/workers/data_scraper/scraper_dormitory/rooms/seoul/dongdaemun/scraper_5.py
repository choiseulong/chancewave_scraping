...
'''
    ...
    method : GET
    url : https://www.ddm.go.kr/health/selectBbsNttList.do?key=1335&bbsNo=221&searchCtgry=&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.ddm.go.kr/health/selectBbsNttView.do?key=1335&bbsNo=221&nttNo={post_id}&searchCtgry=&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex=1
    header :
        None
