...
'''
    ...
    method : GET
    url : https://www.ddm.go.kr/ddm/cultureBBS.jsp?pageNo={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.ddm.go.kr/ddm/cultureBBSview.jsp?pid={postId}&searchParam1=&searchParam2=&pageNo=1&blockNo=0
    header :
        None
