...
'''
    ...
    method : GET
    url : https://www.ddm.go.kr/ddm/eduBBS.jsp?pageNo={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.ddm.go.kr/ddm/eduBBS.jsp?pid={postId}&searchParam1=&searchParam2=&pageNo=1&blockNo=0
    header :
        None
