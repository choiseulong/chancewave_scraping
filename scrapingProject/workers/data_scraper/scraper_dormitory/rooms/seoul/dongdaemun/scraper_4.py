...
'''
    ...
    method : GET
    url : https://www.ddm.go.kr/reserve/selectBbsNttList.do?key=3103&bbsNo=293&searchCtgry=&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex={page_count}
    header :
        None
...
def post_list_parsing_process(**params):
    ...
    table_column_list = ['번호', '제목', '담당부서', '작성일', '파일']
    ...
    # 작성 당시 데이터 X, 데이터 보유시 오류 발생하도록 처리
    if post_list_table_bs.text.find('등록된 게시물이 없습니다') < 0:
        raise TypeError('PLEASE CHECK DATA')
    else:
        return
