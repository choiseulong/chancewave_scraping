...
class Scraper(ABCScraper):
    def __init__(self, session):
        ...
        self.channelName = '창원시청'
        self.postBoardName = '새소식'
        self.channelMainUrl = 'https://www.changwon.go.kr'
        self.postUrl = 'https://www.changwon.go.kr/portal/bbs/view.do?bIdx={}&ptIdx=100&mId=0201010000'
