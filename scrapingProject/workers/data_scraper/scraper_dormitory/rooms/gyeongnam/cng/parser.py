...
def post_list_parsing_process(**params):
    target_key_info = {
        ...
        'uploader', 'post_thumbnail', 'post_subject']
    }
    ...
    for li in liList:
        ...
        t3wrap = extract_children_tag(li, 'i', {'class' :'t3wrap'}, DataStatus.not_multiple)
        spanList = extract_children_tag(t3wrap, 'span', DataStatus.empty_attrs, DataStatus.multiple)
