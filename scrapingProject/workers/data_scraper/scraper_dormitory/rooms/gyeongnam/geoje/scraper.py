...
'''
    ...
    method : GET
    url =  https://www.geoje.go.kr/board/list.geoje?boardId=BBS_0000008&menuCd=DOM_000008902001001000&startPage={page_count}
    header :
        None
...
class Scraper(ABCScraper):
    def __init__(self, session):
        ...
        self.channel_name = '거제시청'
        self.post_board_name = '새소식'
        self.channel_main_url = 'https://www.geoje.go.kr'
