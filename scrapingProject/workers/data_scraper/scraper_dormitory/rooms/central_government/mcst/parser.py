...
def post_content_parsing_process(**params):
    ...
    var, soup, key_list, _ = html_type_default_setting(params, target_key_info)
    content_body = extract_children_tag(soup, 'div', {'class' : 'view_synap'}, DataStatus.not_multiple)
    dtList = extract_children_tag(content_body, 'dt', DataStatus.empty_attrs, DataStatus.multiple)
    for dt in dtList:
