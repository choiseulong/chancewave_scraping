...
def post_list_parsing_process(**params):
    ...
    for tr in tr_list:
        ...
        for td_idx, td in enumerate(td_list):
            ...
            #     break
            if td_idx == 1:
                strong = extract_children_tag(tr, 'strong', DataStatus.empty_attrs, DataStatus.not_multiple)
...
def post_content_parsing_process(**params):
    ...
    spanList = extract_children_tag(soup, 'span', {'class' : 'info_tit'}, DataStatus.multiple)
    ...
    contents = extract_children_tag(soup, 'div', {'class' : 'b_content'}, DataStatus.not_multiple)
    ...
    dlList = extract_children_tag(soup, 'dl', DataStatus.empty_attrs, DataStatus.multiple)
