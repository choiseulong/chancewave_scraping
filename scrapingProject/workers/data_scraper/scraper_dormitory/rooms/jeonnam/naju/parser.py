...
def post_content_parsing_process(**params):
    ...
    viewbox = extract_children_tag(soup, 'div', {'class' : 'viewbox'}, DataStatus.not_multiple)
    var['post_text'] = extract_text(viewbox)
    var['contact'] = extract_contact_numbers_from_text(extract_text(viewbox))
    var['post_image_url'] = search_img_list_in_contents(viewbox, var['channel_main_url'])
    value_list = [var[key] for key in key_list]
