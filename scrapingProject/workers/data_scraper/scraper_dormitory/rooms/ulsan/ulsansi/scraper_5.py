...
'''
    @post list
    method : GET
    url_0 = https://www.ulsan.go.kr/u/culture/bbs/list.ulsan?\
        bbsId=BBS_0000000000000051&mId=001001000000000000&page={}
    header :
        None
...
class Scraper(parents_scraper):
    def __init__(self, session):
        ...
        self.post_url = 'https://www.ulsan.go.kr/u/culture/bbs'