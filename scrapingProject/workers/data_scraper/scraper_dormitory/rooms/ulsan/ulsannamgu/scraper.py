...
'''
    @post list
    method : GET
    url_0 = https://www.ulsannamgu.go.kr/cop/bbs/anonymous/selectBoardList.do?\
        bbsId=namguNews&nttId=0&bbsTyCode=BBST01&bbsAttrbCode=BBSA03&authFlag=Y&pageIndex={page_count}
    header :
        None
