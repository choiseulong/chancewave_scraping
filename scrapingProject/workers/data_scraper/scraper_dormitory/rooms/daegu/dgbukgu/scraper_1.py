...
class Scraper(ABCScraper):
    def __init__(self, session):
        ...
        self.post_board_name = '홍보/행사'
        self.post_url = 'https://www.buk.daegu.kr/index.do?menu_link=/icms/bbs/selectBoardArticle.do&menu_id=00000196&bbsId=BBSMSTR_000000001052&bbsTyCode=BBST01&bbsAttrbCode=BBSA03&nttId={}'
