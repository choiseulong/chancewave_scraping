...
'''
    ...
    method : GET
    url : https://www.yp21.go.kr/health/selectBbsNttList.do?key=1697&bbsNo=177&searchCtgry=&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex={}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.yp21.go.kr/health/selectBbsNttView.do?key=1697&bbsNo=177&nttNo={post_id}&searchCtgry=&searchCnd=all&searchKrwd=&pageIndex=2&integrDeptCode=
    header :
        None
...
class Scraper(ABCScraper):
    def __init__(self, session):
        ...
        self.channel_name = '양평군'
        self.post_board_name = '보건소 공지사항'
        self.channel_main_url = 'https://www.yp21.go.kr'
