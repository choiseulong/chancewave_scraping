...
'''
    ...
    method : GET
    url : https://www.yp21.go.kr/www/selectBbsNttList.do?key=1111&bbsNo=1&searchCtgry=&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex={pageCount}
    header :
        None
...
'''
    @post info
    method : GET
    url : 'https://www.yp21.go.kr/www/selectBbsNttView.do?key=1111&bbsNo=1&nttNo={postId}&searchCtgry=&searchCnd=all&searchKrwd=&pageIndex=1&integrDeptCode=
    header :
        None
