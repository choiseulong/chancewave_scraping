...
'''
    ...
    method : GET
    url = https://www2.ansan.go.kr/www/common/bbs/selectPageListBbs.do?key=264&bbs_code=B0231&bbs_seq=&sch_type=sj&sch_text=&currentPage={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www2.ansan.go.kr/www/common/bbs/selectBbsDetail.do?key=264&bbs_code=B0231&sch_type=sj&sch_text=&currentPage=1&bbs_seq={post_id}
    header :
        None
        ...
        for idx, tmp_td in enumerate(tmp_post_row.find_all('td')):
            ...
            if idx == 0:
                ...
                var['post_url'].append(make_absolute_url(
                    in_url='/www/common/bbs/selectBbsDetail.do?key=264&bbs_code=B0231&sch_type=sj&sch_text=&currentPage=1&bbs_seq=' + post_idx, channel_main_url=var['response'].url))
            elif idx == 3:
