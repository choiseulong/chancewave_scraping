...
'''
    ...
    method : GET
    url = https://www2.ansan.go.kr/www/common/bbs/selectPageListBbs.do?key=260&bbs_code=B0214&bbs_seq=&sch_type=sj&sch_text=&currentPage={}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www2.ansan.go.kr/www/common/bbs/selectBbsDetail.do?key=260&bbs_code=B0214&sch_type=sj&sch_text=&currentPage=1&bbs_seq={post_id]
    header :
        None
...
def post_list_parsing_process(**params):
    ...
    table_column_list = ['번호', '제목', '등록부서', '등록일', '문의처', '조회수', '첨부파일']
        ...
        for idx, tmp_td in enumerate(tmp_post_row.find_all('td')):
            ...
            if idx == 0:
                ...
                var['post_url'].append(make_absolute_url(
                    in_url='/www/common/bbs/selectBbsDetail.do?key=260&bbs_code=B0214&sch_type=sj&sch_text=&currentPage=1&bbs_seq=' + post_idx, channel_main_url=var['response'].url))
            elif idx == 3:
