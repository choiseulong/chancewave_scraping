...
'''
    ...
    method : GET
    url = https://www2.ansan.go.kr/www/common/bbs/selectPageListBbs.do?key=383&bbs_code=B0261&bbs_seq=&sch_type=sj&sch_text=&currentPage={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www2.ansan.go.kr/www/common/bbs/selectBbsDetail.do?key=383&bbs_code=B0261&sch_type=sj&sch_text=&currentPage=1&bbs_seq={post_id}
    header :
        None
...
class Scraper(ABCScraper):
    def __init__(self, session):
        ...
        self.post_board_name = '경제/일자리 공지사항'
...
def post_list_parsing_process(**params):
    ...
    table_column_list = ['번호', '제목', '등록부서', '등록일', '조회수', '파일']
        ...
        for idx, tmp_td in enumerate(tmp_post_row.find_all('td')):
            ...
            if idx == 0:
                ...
                var['post_url'].append(make_absolute_url(
                    in_url='/www/common/bbs/selectBbsDetail.do?key=383&bbs_code=B0261&sch_type=sj&sch_text=&currentPage=1&bbs_seq=' + post_idx, channel_main_url=var['response'].url))
            elif idx == 3:
