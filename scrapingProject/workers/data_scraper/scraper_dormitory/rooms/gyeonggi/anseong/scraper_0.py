...
'''
    ...
    method : GET
    url : https://www.anseong.go.kr/portal/bbs/list.do?ptIdx=16&mId=0401010000&bIdx=&page={pageCount}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.anseong.go.kr/portal/bbs/view.do?ptIdx=16&bIdx={postId}&mId=0401010000
    header :
        None
...
def post_content_parsing_process(**params):
    ...
    var['uploader'] = str_grab(uploader_area.text, ':', '(').strip()
