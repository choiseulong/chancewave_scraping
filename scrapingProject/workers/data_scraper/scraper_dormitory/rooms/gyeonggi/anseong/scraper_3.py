...
'''
    ...
    method : GET
    url : https://www.anseong.go.kr/depart/phyedu/bbs/list.do?ptIdx=16&mId=0802050000&page={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.anseong.go.kr/depart/phyedu/bbs/view.do?ptIdx=16&bIdx={post_id}&mId=0802050000
    header :
        None
