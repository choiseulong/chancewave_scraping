...
'''
    ...
    method : GET
    url : https://www.siheung.go.kr/main/bbs/list.do?ptIdx=173&mId=0401100000&page={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.siheung.go.kr/main/bbs/view.do?bIdx={post_id}&ptIdx=173&mId=0401100000
    header :
        None
