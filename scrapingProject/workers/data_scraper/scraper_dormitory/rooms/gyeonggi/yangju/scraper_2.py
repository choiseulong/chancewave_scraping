...
'''
    ...
    method : GET
    url : https://www.yangju.go.kr/health/selectBbsNttList.do?key=1594&bbsNo=102&searchCtgry=&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.yangju.go.kr/health/selectBbsNttView.do?key=1594&bbsNo=102&nttNo={post_id}&searchCtgry=&searchCnd=all&searchKrwd=&pageIndex=1&integrDeptCode=
    header :
        None
