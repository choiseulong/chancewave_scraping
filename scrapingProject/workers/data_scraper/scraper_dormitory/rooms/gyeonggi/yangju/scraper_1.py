...
'''
    ...
    method : GET
    url : https://www.yangju.go.kr/www/selectBbsNttList.do?key=202&bbsNo=13&searchCtgry=&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.yangju.go.kr/www/selectBbsNttView.do?key=202&bbsNo=13&nttNo={postId}&searchCtgry=&searchCnd=all&searchKrwd=&pageIndex=1&integrDeptCode=
    header :
        None
...
class Scraper(ABCScraper):
    def __init__(self, session):
        ...
        self.channel_name = '양주시'
        self.post_board_name = '양주소식'
        self.channel_main_url = 'https://www.yangju.go.kr'
...
def post_list_parsing_process(**params):
    target_key_info = {
        'multiple_type': ['post_url', 'uploader', 'view_count', 'start_date', 'end_date']
    }
    ...
    table_column_list = ['번호', '제목', '부서', '시작일', '종료일', '파일', '조회수']
    ...
    for tmp_post_row in post_row_list:
        ...
        for idx, tmp_td in enumerate(tmp_post_row.find_all('td')):
            ...
            if idx == 0:
                ...
                var['end_date'].append(convert_datetime_string_to_isoformat_datetime(tmp_td.text.strip()))
            elif idx == 6:
