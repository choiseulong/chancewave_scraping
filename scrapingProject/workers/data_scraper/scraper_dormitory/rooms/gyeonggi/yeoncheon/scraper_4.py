...
'''
    ...
    method : GET
    url : https://www.yeoncheon.go.kr/health/selectBbsNttList.do?key=3762&id=&bbsNo=168&searchCtgry=&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&searchDeptCode=&frstRegisterPnttmSdt=&frstRegisterPnttmEdt=&searchDeleteAt=N&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.yeoncheon.go.kr/health/selectBbsNttView.do?key=3762&id=&bbsNo=168&nttNo={post_id}&searchCtgry=&searchCnd=all&searchKrwd=&pageIndex=1&&frstRegisterPnttmSdt=&frstRegisterPnttmEdt=&searchDeleteAt=N&integrDeptCode=&searchDeptCode=
    header :
        None
