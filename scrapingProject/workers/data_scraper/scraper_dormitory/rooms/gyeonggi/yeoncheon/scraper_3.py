...
'''
    ...
    method : GET
    url : https://www.yeoncheon.go.kr/www/selectBbsNttList.do?key=3524&id=&bbsNo=260&searchCtgry=&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&searchDeptCode=&frstRegisterPnttmSdt=&frstRegisterPnttmEdt=&searchDeleteAt=N&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.yeoncheon.go.kr/www/selectBbsNttView.do?key=3524&id=&bbsNo=260&nttNo={post_id}&searchCtgry=&searchCnd=all&searchKrwd=&pageIndex=1&&frstRegisterPnttmSdt=&frstRegisterPnttmEdt=&searchDeleteAt=N&integrDeptCode=&searchDeptCode=
    header :
        None
