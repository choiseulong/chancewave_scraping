...
'''
    ...
    method : GET
    url : https://www.anyang.go.kr/main/selectBbsNttList.do?key=261&bbsNo=63&searchCtgry=&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.anyang.go.kr/main/selectBbsNttView.do?key=261&bbsNo=63&nttNo={post_id}&searchCtgry=&searchKrwd=&pageIndex=1&integrDeptCode=
    header :
        None
...
class Scraper(ABCScraper):
    def __init__(self, session):
        ...
        self.channel_name = '안양시'
        self.post_board_name = '행사교육'
        self.channel_main_url = 'https://www.anyang.go.kr'
...
def post_list_parsing_process(**params):
    ...
    table_column_list = ['번호', '제목', '부서명', '파일', '작성일', '조회수']
