...
'''
    ...
    method : GET
    url : https://www.anyang.go.kr/main/selectBbsNttList.do?key=275&bbsNo=72&searchCtgry=&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.anyang.go.kr/main/selectBbsNttView.do?key=275&bbsNo=72&nttNo={post_id}&searchCtgry=&searchKrwd=&pageIndex=1&integrDeptCode=
    header :
        None
...
def post_list_parsing_process(**params):
    ...
    table_column_list = ['번호', '제목', '기관', '파일', '작성일', '조회수']
