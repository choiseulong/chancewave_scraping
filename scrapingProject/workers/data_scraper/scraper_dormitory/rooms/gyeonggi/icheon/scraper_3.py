...
'''
    ...
    method : GET
    url = https://www.icheon.go.kr/depart/selectBbsNttList.do?key=2325&id=&bbsNo=132&searchCtgry=&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&searchDeptCode=&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.icheon.go.kr/depart/selectBbsNttView.do?key=2325&id=&bbsNo=132&nttNo={post_id}&searchCtgry=&searchCnd=all&searchKrwd=&pageIndex=1&integrDeptCode=&searchDeptCode=
    header :
        None
