...
'''
    ...
    method : GET
    url = https://www.icheon.go.kr/portal/selectBbsNttList.do?key=3714&id=&bbsNo=17&searchCtgry=&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&searchDeptCode=&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.icheon.go.kr/portal/selectBbsNttView.do?key=3714&id=&bbsNo=17&nttNo={post_id}&searchCtgry=&searchCnd=all&searchKrwd=&pageIndex=1&integrDeptCode=&searchDeptCode=
    header :
        None
...
def post_content_parsing_process(**params):
    ...
    for tmp_row_area in content_info_area.find_all('tr'):
        for tmp_info_title, tmp_info_value in zip(tmp_row_area.find_all('th'), tmp_row_area.find_all('td')):
            ...
            elif tmp_info_title_text == '담당연락처':
