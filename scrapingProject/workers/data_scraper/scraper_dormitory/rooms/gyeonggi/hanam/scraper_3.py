...
'''
    ...
    method : GET
    url = https://www.hanam.go.kr/health/selectBbsNttList.do?key=915&bbsNo=109&searchCtgry=&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.hanam.go.kr/health/selectBbsNttView.do?key=915&bbsNo=109&nttNo={post_id}&searchCtgry=&searchCnd=all&searchKrwd=&pageIndex=1&integrDeptCode=
    header :
        None
    ...
    for tmp_info_row in content_info_row_list:
        ...
        for tmp_column_title_area, tmp_column_value_area in zip(tmp_column_title_area_list, tmp_column_value_area_list):
            ...
            if tmp_column_title_text == '문의전화':
                ...
                var['post_text'] = tmp_column_value_text
