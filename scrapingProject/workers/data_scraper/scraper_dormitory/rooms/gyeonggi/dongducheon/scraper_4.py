...
'''
    ...
    method : GET
    url : https://edu.ddc.go.kr/ddcedu/courseList.do?key=130&srcEdu=285&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://edu.ddc.go.kr/ddcedu/courseView.do?key=130&course={post_id}&srcYear=&srcQuarter=
    header :
        None
...
class Scraper(ABCScraper):
    def __init__(self, session):
        ...
        self.post_board_name = '평생교육 특화과정'
