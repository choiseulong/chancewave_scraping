...
'''
    ...
    method : GET
    url : https://www.ddc.go.kr/ddc/selectBbsNttList.do?key=105&bbsNo=25&searchCtgry=&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.ddc.go.kr/ddc/selectBbsNttView.do?key=105&bbsNo=25&nttNo={post_id}&searchCtgry=&searchCnd=all&searchKrwd=&pageIndex=1&integrDeptCode=
    header :
        None
