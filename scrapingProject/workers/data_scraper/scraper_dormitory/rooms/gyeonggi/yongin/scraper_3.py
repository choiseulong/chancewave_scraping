...
'''
    ...
    method : GET
    url : https://www.yongin.go.kr/user/bbs/BD_selectBbsList.do?q_bbsCode=1143&q_currPage={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.yongin.go.kr/user/bbs/BD_selectBbs.do?q_bbsCode=1143&q_bbscttSn={post_id}
    header :
        None
...
def post_list_parsing_process(**params):
    ...
    table_column_list = ['번호', '사업명', '등록자명', '등록일시', '조회수']
...
def post_content_parsing_process(**params):
    target_key_info = {
        'single_type': ['post_text', 'post_title', 'contact', 'post_subject', 'start_date', 'end_date'],
