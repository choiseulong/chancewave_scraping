...
'''
    ...
    method : GET
    url = https://edu.pocheon.go.kr/www/selectBbsNttList.do?key=105&bbsNo=4&searchCtgry=&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://edu.pocheon.go.kr/www/selectBbsNttView.do?key=105&bbsNo=4&nttNo={post_id}&searchCtgry=&searchCnd=all&searchKrwd=&pageIndex=1&integrDeptCode=
    header :
        None
...
class Scraper(ABCScraper):
    def __init__(self, session):
        ...
        self.post_board_name = '평생학습센터 공지사항'
        self.channel_main_url = 'https://edu.pocheon.go.kr/'
