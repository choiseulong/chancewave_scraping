...
'''
    ...
    method : GET
    url = https://www.pocheon.go.kr/pbhlth/selectBbsNttList.do?bbsNo=61&key=7175&pageUnit=10&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.pocheon.go.kr/pbhlth/selectBbsNttView.do?bbsNo=61&nttNo={post_id}&key=7175&pageUnit=10&pageIndex=1
    header :
        None
