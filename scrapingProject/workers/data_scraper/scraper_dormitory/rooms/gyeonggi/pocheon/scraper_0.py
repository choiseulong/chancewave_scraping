...
'''
    ...
    method : GET
    url = https://www.pocheon.go.kr/www/selectBbsNttList.do?bbsNo=18&key=3095&pageUnit=10&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.pocheon.go.kr/www/selectBbsNttView.do?bbsNo=18&nttNo={postId}&key=3095&pageUnit=10&pageIndex=1
    header :
        None
...
def post_list_parsing_process(**params):
    ...
    table_column_list = ['번호', '제목', '작성부서', '파일', '조회수', '작성일', '수정일']
