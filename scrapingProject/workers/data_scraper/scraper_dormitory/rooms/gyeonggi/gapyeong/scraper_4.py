...
'''
    ...
    method : GET
    url = https://www.gp.go.kr/portal/selectBbsNttList.do?key=2169&bbsNo=531&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.gp.go.kr/portal/selectBbsNttView.do?key=2169&bbsNo=531&nttNo={post_id}&searchCtgry=&searchCnd=all&searchKrwd=&pageIndex=2&integrDeptCode=
    header :
        None
