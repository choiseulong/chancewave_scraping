...
'''
    ...
    method : GET
    url = https://www.gp.go.kr/portal/selectBbsNttList.do?key=443&bbsNo=768&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.gp.go.kr/portal/selectBbsNttView.do?key=443&bbsNo=76&nttNo={post_id}&searchCtgry=&searchCnd=all&searchKrwd=
    header :
        None
    ...
    for tmp_post_row in post_row_list:
        ...
        for idx, tmp_td in enumerate(tmp_post_row.find_all('td')):
            ...
            if idx == 1:
                ...
                var['post_url'].append(
                    make_absolute_url(in_url=tmp_td.find('a').get('href'), channel_main_url=var['response'].url))
            elif idx == 5:
