...
'''
    ...
    method : GET
    url : https://www.osan.go.kr/portal/bbs/list.do?ptIdx=111&mId=0301010000&page={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : 'https://www.osan.go.kr/portal/portal/bbs/view.do?mId=0301010000&bIdx={postId}}&ptIdx=111
    header :
        None
