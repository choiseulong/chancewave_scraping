...
'''
    ...
    method : GET
    url : https://www.osan.go.kr/depart/bbs/list.do?ptIdx=111&mId=0401010000&page={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.osan.go.kr/depart/depart/bbs/view.do?mId=0401010000&bIdx={post_id}&ptIdx=111
    header :
        None
