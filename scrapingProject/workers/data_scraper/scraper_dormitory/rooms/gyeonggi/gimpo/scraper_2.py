...
'''
    ...
    method : GET
    url : https://www.gimpo.go.kr/health/selectBbsNttList.do?key=2218&bbsNo=44&searchCnd=all&deleteAt=N&pageUnit=10&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.gimpo.go.kr/health/selectBbsNttView.do;jsessionid=mwUSXayJZGVX4bTJdbCGKCubPtzb0DsoKRg2M1nwjZkD9aSipVBTMJkuAFU1OyOW.new-gimpo-was2_servlet_engine1?key=2218&bbsNo=44&searchCnd=all&deleteAt=N&pageUnit=10&pageIndex=1&nttNo={post_id}
    header :
        None
