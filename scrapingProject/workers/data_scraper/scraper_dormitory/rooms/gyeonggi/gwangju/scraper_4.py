...
'''
    ...
    method : GET
    url : https://www.gjcity.go.kr/depart/bbs/list.do?ptIdx=1&mId=0802010000&searchDept=55400160000&page={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.gjcity.go.kr/depart/bbs/view.do?bIdx={post_id}&ptIdx=1&mId=0802010000
    header :
        None
