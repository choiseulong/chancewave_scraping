...
'''
    ...
    method : GET
    url : https://www.gjcity.go.kr/depart/bbs/list.do?ptIdx=1&searchDept=55402470000&mId=1001010000&page={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.gjcity.go.kr/depart/bbs/view.do?bIdx={post_id}&ptIdx=1&mId=1001010000
    header :
        None
