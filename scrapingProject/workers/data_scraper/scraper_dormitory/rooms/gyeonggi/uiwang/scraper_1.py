...
'''
    ...
    method : GET
    url : https://www.uiwang.go.kr/UWKORCOM0401?curPage={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.uiwang.go.kr/UWKORCOM0401/{post_id}/?curPage=1
    header :
        None
...
def post_list_parsing_process(**params):
    ...
    table_column_list = ['번호', '제목', '작성자', '작성일', '조회']
