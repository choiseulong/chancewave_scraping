...
'''
    ...
    method : GET
    url : https://www.uiwang.go.kr/UWKORINFO0101?curPage={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.uiwang.go.kr/UWKORINFO0101/{postId}/?curPage=3
    header :
        None
...
class Scraper(ABCScraper):
    def __init__(self, session):
        ...
        self.channel_name = '의왕시'
        self.post_board_name = '공지사항'
        self.channel_main_url = 'https://www.uiwang.go.kr'
...
def post_list_parsing_process(**params):
    ...
    table_column_list = ['번호', '제목', '작성일', '조회']

    # 게시물 리스트 테이블 영역
    post_list_table_bs = soup.find('div', class_='bbs-list')
...
def post_content_parsing_process(**params):
    target_key_info = {
        'single_type': ['post_text', 'post_title', 'uploader', 'post_subject', 'contact'],
    ...
    context_area = content_info_area.find('td', class_='viewWrap')
