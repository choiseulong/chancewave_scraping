...
'''
    ...
    method : GET
    url : https://www.guri.go.kr/brd/board/1044/L/menu/1678?brdType=L&thisPage={page_count}&searchField=&searchText=
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.guri.go.kr/brd/board/1044/L/menu/1678?brdType=R&thisPage=1&bbIdx={post_id}=&searchField=&searchText=
    header :
        None
