...
'''
    ...
    method : GET
    url = https://www.ui4u.go.kr/depart/industry/bbs/list.do?ptIdx=35&mId=0403000000&bIdx=&page={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.ui4u.go.kr/portal/bbs/view.do?mId=0403000000&bIdx={post_id}&ptIdx=35
    header :
        None
