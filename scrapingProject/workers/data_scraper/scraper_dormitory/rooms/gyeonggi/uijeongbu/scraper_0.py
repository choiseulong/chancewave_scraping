...
'''
    ...
    method : GET
    url = https://www.ui4u.go.kr/portal/bbs/list.do?ptIdx=35&mId=0301010000&bIdx=&page={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.ui4u.go.kr/portal/bbs/view.do?mId={postId}&bIdx=241945&ptIdx=35
    header :
        None
