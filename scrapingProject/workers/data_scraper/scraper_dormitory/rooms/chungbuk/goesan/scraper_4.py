...
'''
    ...
    method : GET
    url : https://www.goesan.go.kr/health/selectBbsNttList.do?key=741&bbsNo=190&searchCtgry=%%EB%%B3%%B4%%EA%%B1%%B4%%EC%%86%%8C&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex={}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.goesan.go.kr/health/selectBbsNttView.do?key=741&bbsNo=190&nttNo=82249&searchCtgry=보건소&searchCnd=all&searchKrwd=&pageIndex={}&integrDeptCode=
    header :
        None
