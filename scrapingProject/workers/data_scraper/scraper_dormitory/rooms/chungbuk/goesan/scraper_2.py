...
'''
    ...
    method : GET
    url : https://www.goesan.go.kr/www/selectBbsNttList.do?key=143&bbsNo=219&searchCtgry=&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.goesan.go.kr/www/selectBbsNttView.do?key=143&bbsNo=219&nttNo={}&searchCtgry=&searchCnd=all&searchKrwd=&pageIndex=1&integrDeptCode=
    header :
        None
