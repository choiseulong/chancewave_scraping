...
'''
    ...
    method : GET
    url : https://www.jecheon.go.kr/www/selectBbsNttList.do?key=128&id=&&bbsNo=24&searchCtgry=&pageUnit=10&searchCnd=&searchKrwd=&integrDeptCode=&pageIndex={page_count}
    header :
        None
...
class Scraper(ABCScraper):
    def __init__(self, session):
        ...
        self.post_board_name = '교육포털 공지사항'
...
def post_list_parsing_process(**params):
    ...
    table_column_list = ['번호', '제목', '첨부파일', '조회수', '작성일', '작성자']
