...
'''
    ...
    method : GET
    url : https://www.jecheon.go.kr/health/selectBbsNttList.do?key=944&id=&&bbsNo=170&searchCtgry=&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex={page_count  }
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.jecheon.go.kr/health/selectBbsNttView.do?key=944&id=&&bbsNo=170&nttNo={}&searchCtgry=&searchCnd=&searchKrwd=&pageIndex=1&integrDeptCode=
    header :
        None
...
def post_list_parsing_process(**params):
    ...
    table_column_list = ['번호', '제목', '첨부파일', '작성일', '조회수', '작성자']
