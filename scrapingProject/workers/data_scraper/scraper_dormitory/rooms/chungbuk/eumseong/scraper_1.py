...
'''
    ...
    method : GET
    url : https://www.eumseong.go.kr/www/selectBbsNttList.do?key=88&bbsNo=10&searchCtgry=&pageUnit=15&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.eumseong.go.kr/www/selectBbsNttView.do?key=88&bbsNo=10&nttNo={post_id}&searchCtgry=&searchCnd=all&searchKrwd=&pageIndex=1&integrDeptCode=
    header :
        None
