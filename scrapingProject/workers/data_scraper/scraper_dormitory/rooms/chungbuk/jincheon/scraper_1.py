...
'''
    ...
    method : GET
    url : http://www.jincheon.go.kr/site/edu/sub.do?page={page_count}&menukey=2818
    header :
        None
...
'''
    @post info
    method : GET
    url : http://www.jincheon.go.kr/site/edu/sub.do?menukey=2818&mode=view&no={post_id}&page=1
    header :
        None
