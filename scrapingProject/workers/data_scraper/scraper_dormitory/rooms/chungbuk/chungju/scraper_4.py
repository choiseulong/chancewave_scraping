...
'''
    ...
    method : GET
    url = https://goodedu.chungju.go.kr/edu/selectBbsNttList.do?key=39&bbsNo=1&searchCtgry=&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://goodedu.chungju.go.kr/edu/selectBbsNttView.do?key=39&bbsNo=1&nttNo={post_id}&searchCtgry=&searchCnd=all&searchKrwd=&pageIndex=1&integrDeptCode=
    header :
        None
...
def post_list_parsing_process(**params):
    ...
    table_column_list = ['번호', '제목', '조회수', '작성일']
...
def post_content_parsing_process(**params):
    ...
    content_info_area = soup.find('table', class_='bbs_view')
