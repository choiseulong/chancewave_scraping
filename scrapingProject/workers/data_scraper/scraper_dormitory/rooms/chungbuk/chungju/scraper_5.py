...
'''
    @post info
    method : GET
    url : https://www.chungju.go.kr/welfare/selectBbsNttView.do?key=2222&bbsNo=5&nttNo={post_id}&searchCtgry=%%EB%%B3%%B5%%EC%%A7%%80%%EC%%A0%%95%%EC%%B1%%85%%EA%%B3%%BC&searchCnd=all&searchKrwd=&pageIndex=1&integrDeptCode=
    header :
        None
