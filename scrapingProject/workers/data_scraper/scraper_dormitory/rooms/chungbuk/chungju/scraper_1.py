...
'''
    ...
    method : GET
    url = https://www.chungju.go.kr/www/selectBbsNttList.do?key=507&bbsNo=10&searchCtgry=&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex={page_count}
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.chungju.go.kr/www/selectBbsNttView.do?key=507&bbsNo=10&nttNo={post_id}&searchCtgry=&searchCnd=all&searchKrwd=&pageIndex=1&integrDeptCode=
    header :
        None
...
class Scraper(ABCScraper):
    def __init__(self, session):
        ...
        self.post_board_name = '유관기관 공지사항'
...
def post_list_parsing_process(**params):
    ...
    table_column_list = ['번호', '분류', '제목', '작성일', '조회수']
