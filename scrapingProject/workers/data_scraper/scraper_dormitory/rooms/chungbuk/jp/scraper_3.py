...
'''
    ...
    method : GET
    url : https://www.jp.go.kr/health/cop/bbs/BBSMSTR_000000000082/selectBoardList.do?bbsId=BBSMSTR_000000000082&nttId=0&bbsTyCode=BBST05&bbsAttrbCode=BBSA03&pdfview_at=&authFlag=&pageIndex={page_count}&mno=sitemap_12&searchCnd=0&searchWrd=
    header :
        None
...
'''
    @post info
    method : GET
    url : https://www.jp.go.kr/health/cop/bbs/BBSMSTR_000000000082/selectBoardArticle.do?nttId={post_id}&kind=&mno=sitemap_12&pageIndex=1&searchCnd=0&searchWrd=
    header :
        None
