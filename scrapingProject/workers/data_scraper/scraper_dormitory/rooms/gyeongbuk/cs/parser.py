...
def post_list_parsing_process(**params):
    ...
    for li in liList:
        ...
        spanF1 = extract_children_tag(li, 'span', {'class' : 'f1'}, DataStatus.not_multiple)
        if spanF1:
            img = extract_children_tag(spanF1, 'img', DataStatus.empty_attrs, DataStatus.not_multiple)
        ...
        var['post_title'].append(
            extract_text(
                extract_children_tag(li, 'strong', {"class" : "t1"}, DataStatus.not_multiple)
            )
        )
