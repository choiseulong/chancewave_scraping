...
def post_content_parsing_process(**params):
    ...
    var, soup, key_list, _ = html_type_default_setting(params, target_key_info)
    data_top = extract_children_tag(soup, 'dl', {'class' : 'data_top'}, DataStatus.not_multiple)
    var['post_title'] = extract_text(extract_children_tag(data_top, 'dt', DataStatus.empty_attrs, DataStatus.not_multiple))
    data_contents = extract_children_tag(soup, 'div', {'class' : 'data_contents'}, DataStatus.not_multiple)
