...
class Scraper(metaclass=ABCMeta):
    ...
    def target_contents_scraping(self, post_content_parsing_process, sleep_sec=1):
        '''
    ...
    def target_scraping(self, post_content_parsing_process, target, sleep_sec=1):
        status = ''
